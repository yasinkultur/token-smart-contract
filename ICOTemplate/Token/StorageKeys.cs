namespace Neo.SmartContract
{
    ...
    public class StorageKeys
    {
        ...
        public static string MintTokensEthLastTX() => "lastMintTokensTXHashEth";
        public static string PrivateSaleAllocationLocked() => "PrivateSaleAllocationLocked";
        ...
        public static string WhiteListedTransferFromList() => "WhiteListedTransferFromList";
        public static string WhiteListTransferFromSettingChecked() => "WhiteListTransferFromSettingChecked";
        public static string UnsoldTokensClaimed() => "UnsoldTokensClaimed";
    }
}
